...
class LeftPanel(QWidget):
    ...
    def _setupUi(self):
        ...
        statusLabel1.setFont(QFont('Arial', 18, QFont.Weight.Bold))
        ...
        bsVaoFrame = QFrame()
        bsVaoFrame.setFrameShape(QFrame.Shape.Box)  # Thiết lập hình dạng hộp
        ...
        bsVaoLabel.setFont(QFont('Arial', 36, QFont.Weight.Bold))
        ...
        bsRaLabel.setFont(QFont('Arial', 36, QFont.Weight.Bold))
        ...
        durationValue.setFont(QFont('Arial', 18, QFont.Weight.Bold))
        ...
        vLayout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))

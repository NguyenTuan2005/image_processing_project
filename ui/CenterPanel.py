    ...
    def _setupUi(self):
        ...
        for i in range(2):
            for j in range(2):
                ...
                videoLabel.setFont(QFont('Arial', 14, QFont.Weight.Bold))
                ...
                imgLabel.setPixmap(pixmap.scaled(700, 500, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
                imgIndex += 1
